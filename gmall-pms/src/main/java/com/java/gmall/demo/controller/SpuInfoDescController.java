...
@Api(tags = "spu信息介绍 管理")
@RestController
@RequestMapping("demo/spuinfodesc")
public class SpuInfoDescController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('demo:spuinfodesc:list')")
    ...
    @PreAuthorize("hasAuthority('demo:spuinfodesc:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('demo:spuinfodesc:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('demo:spuinfodesc:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('demo:spuinfodesc:delete')")
