...
public class BrandController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('demo:brand:list')")
    ...
    @PreAuthorize("hasAuthority('demo:brand:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('demo:brand:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('demo:brand:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('demo:brand:delete')")
