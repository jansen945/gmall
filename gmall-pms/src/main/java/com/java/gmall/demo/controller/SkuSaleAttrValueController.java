...
@RestController
@RequestMapping("demo/skusaleattrvalue")
public class SkuSaleAttrValueController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('demo:skusaleattrvalue:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('demo:skusaleattrvalue:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('demo:skusaleattrvalue:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('demo:skusaleattrvalue:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('demo:skusaleattrvalue:delete')")
